...
//Ham xu ly quen password
        public void changePass(String newPassword) {
            if (statue == 1) {
                userC1.updatePass(userC1.getUser1().getUserName(), newPassword);
                passWordField1.setText(newPassword);
                passWarningLabel.setText("Your new password is " + newPassword);
    }
}
    ...
    private void forgetLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_forgetLabelMouseClicked
        // TODO add your handling code here:
            // Hiển thị hộp thoại cho phép người dùng nhập mật khẩu mới
    ...
    if (newPassword != null && !newPassword.isEmpty()) {
        changePass(newPassword); // Gọi phương thức changePass() với mật khẩu mới
        }
